    ...
    <section class="py-16 md:py-24">
      <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
          ...
          >
            Керен Виленски: Музыка, театр и поэзия
          </h2>
...
// Author Bio
const authorBio =
  'Родилась в России в семье военного. Музыкант, режиссёр массовых праздников. Начала писать стихи ещё в школе. В середине 70-х годов была участницей театрального клуба "Суббота". Позже переехала в Беларусь, где работала режиссёром театра "Исход". С 1996 года живу в Израиле, где продолжаю свою творческую деятельность. Я мама пятерых сыновей, которые вдохновляют меня каждый день. Мои стихи — это отражение моего внутреннего мира и жизненного опыта. Искусство всегда было и остаётся для меня способом делиться своим видением и эмоциями с окружающим миром.';
